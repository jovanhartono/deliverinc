                            ...
                            <div className="flex flex-col justify-between space-y-6">
                                <div className={'relative z-10 flex flex-col items-start space-y-6'}>
                                    <div className="space-y-3">
                                        ...
                                        <p className={'description-section'}>Solusi <span className={'amber-clip-text font-semibold'}>utama</span> bagi anda yang mempunyai kendala dalam
                                ...
                                <div className="flex">
                                    <ul className={'grid md:grid-cols-2 gap-3 flex-grow'}>
                                        ...
                                        <li className={'flex items-center space-x-1'}>
                                            ...
                                            <p className={'font-medium text-lg text-transparent bg-gradient-to-b from-amber-600 to-yellow-400 bg-clip-text tracking-tight'}>Terima Beres</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
